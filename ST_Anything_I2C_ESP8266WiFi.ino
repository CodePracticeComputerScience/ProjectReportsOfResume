...
String str_ssid     = "csce5612";                           //  <---You must edit this line!

String str_password = "ntdpf243";                   //  <---You must edit this line!

IPAddress ip(192, 168, 1, 152);       //Device IP Address       //  <---You must edit this line!

IPAddress gateway(10, 120, 61, 250);    //Router gateway          //  <---You must edit this line!
...
IPAddress hubIp(192, 168, 1, 148);    // smartthings/hubitat hub ip //  <---You must edit this line!
